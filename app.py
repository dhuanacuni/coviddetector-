...
label_dict={0:'Covid19 NEGATIVO', 1:'Covid19 POSITIVO'}
#funcion preprosar
def preprocess(img):
...
def predict():
	...
	result=np.argmax(prediction,axis=1)[0]#indice del max valor
	accuracy=float(np.max(prediction,axis=1)[0])#retorna el valor
